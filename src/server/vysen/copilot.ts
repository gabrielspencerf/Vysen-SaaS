...
function buildAdminFallbackAnswer(input: {
  ...
  return [
    ...
    "",
    "3) ações recomendadas (priorizadas)",
    "- P1: validar monitoramento, heartbeat do worker e backlog antes de aprofundar qualquer leitura analítica.",
  ...
  const baseMessages = [
    {
      ...
      content: [
        ...
        "Seu foco: funil, aquisição, negociações, monitoramento, gargalos, melhorias e recomendações acionáveis.",
